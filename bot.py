...
# Конфигурация  
BOT_TOKEN = "8557190026:AAHAhHOxPQ4HlFHbGokpyTFoQ2R_a634rE4"  # Замените на свой токен  
ADMIN_PASSWORD = "vanezypuls13579cod"  
ADMIN_IDS = [6708209142]  # Замените на ваши реальные ID  
...
# Функция проверки блокировки админ-панели  
...
async def callback_admin_panel(callback: CallbackQuery, state: FSMContext):  
    ...
    if callback.message.chat.type != "private":  
        ...
        await callback.message.answer(  
            ...
            f"Перейдите в ЛС с ботом: @{bot.me.username}"  
        )  
        return  
...
if __name__ == "__main__":  
    if BOT_TOKEN == "YOUR_BOT_TOKEN_HERE":  
        ...
        print("1. Замените 'YOUR_BOT_TOKEN_HERE' на ваш токен от @BotFather")  
        print("2. Добавьте ваш Telegram ID в список ADMIN_IDS")  
        print("3. Перезапустите бота")  
        print("\nПример ADMIN_IDS = [123456789, 987654321]")  
    elif not ADMIN_IDS or ADMIN_IDS == [123456789, 987654321]:  
        print("⚠️ ВНИМАНИЕ! Добавьте ваш реальный Telegram ID в список ADMIN_IDS!")  
